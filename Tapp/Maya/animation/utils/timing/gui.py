...
copy from clipboard into key class >< paste from key class to cipboard
accuracy mode
...
import Tapp.Maya.animation.utils.timing.resources.timing as gui
...
class Window(QtGui.QMainWindow,gui.Ui_MainWindow):
    ...
    def mod_layout(self):
        ...
        self.horizontalSlider.setTickPosition(QtGui.QSlider.TickPosition.TicksBelow)

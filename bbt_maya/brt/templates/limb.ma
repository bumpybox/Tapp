...
//Name: limb.ma
//Last modified: Thu, Nov 15, 2012 12:50:35 AM
//Codeset: 1252
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 31.773048158678815 15.500800748927508 5.1260070929810011 ;
	setAttr ".r" -type "double3" -28.538352731215674 73.79999999999788 5.7001004917624292e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 29.733627323169934;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 10.081461300599312 0.52841356163972963 -1.1809300640289671 ;
...
createNode dagContainer -n "limb";
	...
	setAttr -k on ".upperTwist" yes;
	setAttr -k on ".lowerTwist" yes;
...
createNode transform -n "start_cnt" -p "limb";
	...
	setAttr ".t" -type "double3" 2.4377305450569446 5.1575592527819243 -1.8739805868719372 ;
...
createNode transform -n "end_cnt" -p "limb";
	...
	setAttr ".r" -type "double3" 17.899811384212633 -13.700041919908042 -28.227529254526903 ;
...
createNode transform -n "mid_cnt" -p "limb";
	addAttr -ci true -sn "metaParent" -ln "metaParent" -at "message";
	setAttr ".t" -type "double3" 6.6962692123197103 1.5390741312193708 -3.1401824076794083 ;
...
createNode orientConstraint -n "direction_label_orientConstraint1" -p "direction_label";
	...
	setAttr -k off ".sz";
	setAttr ".erp" yes;
	setAttr ".lr" -type "double3" 6.0586251128897048 117.8415794800931 63.314134390698186 ;
...
createNode network -n "meta_end_cnt";
	...
	addAttr -ci true -sn "component" -ln "component" -dt "string";
	addAttr -ci true -sn "metaParent" -ln "metaParent" -at "message";
	addAttr -ci true -sn "switch" -ln "switch" -dt "string";
	addAttr -ci true -sn "worldspace" -ln "worldspace" -dt "string";
	addAttr -ci true -sn "system" -ln "system" -dt "string";
	setAttr ".type" -type "string" "control";
	setAttr ".component" -type "string" "end";
	setAttr ".switch" -type "string" "message";
	setAttr ".worldspace" -type "string" "true";
	setAttr ".system" -type "string" "None";

...
//Name: limb.ma
//Last modified: Thu, Nov 15, 2012 12:14:42 AM
//Codeset: 1252
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 25.121522587200189 13.550673342103783 18.697351389057673 ;
	setAttr ".r" -type "double3" -21.338352729597108 38.600000000001351 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 29.436159911729909;
...
createNode transform -n "mid_cnt" -p "limb";
	addAttr -ci true -sn "metaParent" -ln "metaParent" -at "message";
	setAttr ".t" -type "double3" 9.0388273009668829 4.5288510394705028 -5.4578860709423296 ;
...
createNode orientConstraint -n "direction_label_orientConstraint1" -p "direction_label";
	...
	setAttr -k off ".sz";
	setAttr ".erp" yes;
	setAttr ".lr" -type "double3" -17.550960758015414 59.458692151867041 46.976576923719769 ;

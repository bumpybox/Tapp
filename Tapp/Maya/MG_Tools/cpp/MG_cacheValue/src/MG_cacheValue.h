...
public:
		...
		*/
		...
		/**
		* This attribute holds the start frame amount , when you are at the start frame the cache is deleted and filled
		* with the start frame value.
		*/
		static MObject startFrame; 

		/**
		*The value used to erese the cache
		*/
		static MObject startFrameValue; 
		/**
		*The maya current time
		*/
		static MObject time; 
		/**
		*Wheter or not the node is driven by time change or regular iterations
		*/
		static MObject timeDriven; 
		/**
		*previous frame
		*/
		static MObject timeStored; 
